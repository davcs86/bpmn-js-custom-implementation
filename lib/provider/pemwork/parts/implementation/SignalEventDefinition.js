...
function SignalEventDefinition(group, element, bpmnFactory, signalEventDefinition) {
  group.entries.push({
    ...
    'html': '<div class="pp-row pp-select">' +
              '<label for="pemwork-signals">Signals</label>' +
              '<div class="pp-field-wrapper">' +
                '<select id="pemwork-signals" name="signals" data-value>' +
                '</select>' +
            ...
            '<div class="pp-row pp-textfield" data-show="isSignalSelected">' +
              '<label for="pemwork-signal-name">Signal Name</label>' +
              '<div class="pp-field-wrapper">' +
                '<input id="pemwork-signal-name" type="text" name="signalName" />' +
