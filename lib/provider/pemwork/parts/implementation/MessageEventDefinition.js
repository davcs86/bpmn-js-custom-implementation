...
function MessageEventDefinition(group, element, bpmnFactory, messageEventDefinition) {
  group.entries.push({
    ...
    'html': '<div class="pp-row pp-select">' +
              '<label for="pemwork-messages">Messages</label>' +
              '<div class="pp-field-wrapper">' +
                '<select id="pemwork-messages" name="messages" data-value>' +
                '</select>' +
            ...
            '<div class="pp-row pp-textfield" data-show="isMessageSelected">' +
              '<label for="pemwork-message-name">Message Name</label>' +
              '<div class="pp-field-wrapper">' +
                '<input id="pemwork-message-name" type="text" name="messageName" />' +
