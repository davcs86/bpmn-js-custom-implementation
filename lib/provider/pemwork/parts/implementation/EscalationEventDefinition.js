...
function EscalationEventDefinition(group, element, bpmnFactory, escalationEventDefinition, showEscalationCodeVariable) {
  group.entries.push({
    ...
    'html': '<div class="pp-row pp-select">' +
              '<label for="pemwork-escalation">Escalations</label>' +
              '<div class="pp-field-wrapper">' +
                '<select id="pemwork-escalation" name="escalations" data-value>' +
                '</select>' +
  ...
  if (showEscalationCodeVariable) {
    group.entries.push(entryFactory.textField({
      ...
      get: function(element) {
        ...
        var boEscalationCodeVariable = escalationEventDefinition.get('pemwork:escalationCodeVariable');
      ...
      set: function(element, values) {
        var update = {
          'pemwork:escalationCodeVariable' : undefined
        };

        if (values.escalationCodeVariable !== '') {
          update['pemwork:escalationCodeVariable'] = values.escalationCodeVariable;
        }
